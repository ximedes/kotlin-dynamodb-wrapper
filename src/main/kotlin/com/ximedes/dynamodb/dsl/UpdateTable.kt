...
fun DynamoDbClient.updateTable(table: String, block: UpdateTableRequestBuilder.() -> Unit): UpdateTableResponse {
    return UpdateTableRequestBuilder(table).apply(block).build().logAndRun(::updateTable)
}
